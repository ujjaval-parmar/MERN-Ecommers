...
const AdminEditProduct = ({ product, onClose, getProducts }) => {
    ...
    const handleUploadProduct = async (e) => {
        ...
        try {
            ...
            const response = await apiGanerator('updateProduct', "PUT", true, body);
        ...
        <div className='absolute w-full h-full inset-0 bg-slate-200/70 flex items-center  justify-center '>
            ...
            <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%]  overflow-hidden">
                ...
                <form className='p-4 pb-4  grid gap-1 overflow-auto h-full' onSubmit={handleUploadProduct}>
                    ...
                    <button className='px-3 py-2 bg-red-600 text-white mt-3 mb-4 hover:bg-red-700'>Update Product</button>
